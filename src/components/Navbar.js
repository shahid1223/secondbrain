    ...
    <nav className="bg-white shadow">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0">
            <img className="h-auto w-auto" src="../assets/iconsandlogo/Group.png" alt="Logo" />
          </div>
      ...
      <div className={`${isOpen ? 'block' : 'hidden'} md:hidden`}>
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <div className="flex-shrink-0">
            <img className="h-auto w-auto block px-3 py-2 rounded-md text-base font-medium text-gray-900" src="../assets/iconsandlogo/Group.png" alt="Logo" />
          </div>
